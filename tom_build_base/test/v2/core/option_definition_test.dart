...
void main() {
  ...
  group('OptionDefinition', () {
    ...
    group('multi factory', () {
      ...
      test('BB-OPT-11: Creates multi-value option with all fields [2026-02-12]', () {
        const opt = OptionDefinition.multi(
          name: 'tag',
          abbr: 't',
    ...
    group('usage', () {
      ...
      test('BB-OPT-14: Generates usage for option with value name [2026-02-12]', () {
        const opt = OptionDefinition.option(
          name: 'config',
          abbr: 'c',
          description: 'Config',
      ...
      test('BB-OPT-15: Generates usage for option without abbr [2026-02-12]', () {
        const opt = OptionDefinition.option(
          name: 'config',
          description: 'Config',
          valueName: 'path',
  ...
  group('Standard option definitions', () {
    test('BB-OPT-18: projectTraversalOptions contains expected options [2026-02-12]', () {
    ...
    test('BB-OPT-19: Scan option has correct attributes [2026-02-12]', () {
      final scan =
          projectTraversalOptions.firstWhere((o) => o.name == 'scan');
    ...
    test('BB-OPT-20: Recursive option is a flag [2026-02-12]', () {
      final recursive =
          projectTraversalOptions.firstWhere((o) => o.name == 'recursive');
    ...
    test('BB-OPT-21: Project option is multi-value [2026-02-12]', () {
      final project =
          projectTraversalOptions.firstWhere((o) => o.name == 'project');

      expect(project.abbr, equals('p'));
      expect(project.type, equals(OptionType.multiOption));
    });

    test('BB-OPT-22: gitTraversalOptions contains expected options [2026-02-12]', () {
    ...
    test('BB-OPT-23: Modules option has correct attributes [2026-02-12]', () {
      final modules =
          gitTraversalOptions.firstWhere((o) => o.name == 'modules');
    ...
    test('BB-OPT-24: Inner-first-git option is a flag [2026-02-12]', () {
      final innerFirst =
          gitTraversalOptions.firstWhere((o) => o.name == 'inner-first-git');
