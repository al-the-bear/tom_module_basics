...
void main() {
  ...
  setUp(() {
    ...
    File('${tempDir.path}/dart_console/pubspec.yaml')
        .writeAsStringSync('name: dart_console\n');

    // dart_package
    Directory('${tempDir.path}/dart_package/lib/src')
        .createSync(recursive: true);
    File('${tempDir.path}/dart_package/pubspec.yaml')
    ...
    File('${tempDir.path}/git_dart/pubspec.yaml')
        .writeAsStringSync('name: git_dart\n');

    // buildkit_proj (buildkit + dart)
    Directory('${tempDir.path}/buildkit_proj').createSync(recursive: true);
    File('${tempDir.path}/buildkit_proj/buildkit.yaml')
        .writeAsStringSync('');
    File('${tempDir.path}/buildkit_proj/pubspec.yaml')
