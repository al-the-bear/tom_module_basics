/// Tom Test Kit v2 CLI — test result tracking tool using v2 framework.
///
/// This is the v2 entry point that uses tom_build_base v2 for CLI handling.
/// Run `testkit_v2 --help` for usage information.
library;
