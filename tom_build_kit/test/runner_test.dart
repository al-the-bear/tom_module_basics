...
void main() {
  ...
  group('runner', () {
    ...
    test('--include-builders filters to specific builders', () async {
      ...
      log.capture('runner --dry-run --include-builders tom_d4rt_generator',
          result);
      ...
      final hasFilterInfo = stdout.contains('define') ||
    ...
    test('--command clean shows clean command in dry-run', () async {
      ...
      final result = await ws.runTool('runner',
          ['--project', '_build', '--dry-run', '--command', 'clean']);
      ...
      expect(hasClean, isTrue,
          reason: 'Dry-run should show "clean" command');
