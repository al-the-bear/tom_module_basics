...
class VersionerConfig {
  ...
  static VersionerConfig? loadFromBuildYaml(String dir,
    ...
    try {
      ...
      YamlMap? options;
      for (final key in [builderKey, 'tom_version_builder:version_builder']) {
...
class VersionerTool extends ToolBase {
  ...
  bool _hasBuildYamlVersionConfig(String dirPath) {
    ...
    try {
      final content = file.readAsStringSync();
      return content.contains('tom_version_builder:version_builder') ||
          content.contains('tom_build_kit:version_builder');
    } catch (_) {
      return false;
    }
  }
...
// Generated by tom_build_kit versioner
