...
void _printBuildYamlSection(String projectPath, String workspaceRoot) {
  ...
  try {
    ...
    // Navigate to tom_version_builder:version_builder section
    ...
    if (versionBuilder == null) {
      print('    (no tom_version_builder:version_builder section)');
      return;
    }
    
    // Print the version_builder section as YAML
    print('    build.yaml:');
    _printYamlNode(versionBuilder, indent: 6);
  } catch (e) {
